...
export class Config {
    ...
    'jhipster.mail.from' = 'app@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'app API';
    'jhipster.swagger.description' = 'app API documentation';
    ...
    'eureka.instance.instanceId' = 'app:${random.value}';
